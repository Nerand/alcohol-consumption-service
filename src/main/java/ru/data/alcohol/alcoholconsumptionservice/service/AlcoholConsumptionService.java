...
@Service
@Profile("csv")
public class AlcoholConsumptionService implements AlcoholConsumptionServiceInterface {

    private final AlcoholConsumptionCsvRepository repository;

    public AlcoholConsumptionService(AlcoholConsumptionCsvRepository repository) {
